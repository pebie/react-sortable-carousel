...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsRoot = __webpack_require__(158);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDndModulesBackendsHTML5 = __webpack_require__(159);

	var _reactDndModulesBackendsHTML52 = _interopRequireDefault(_reactDndModulesBackendsHTML5);

	var _reactDnd = __webpack_require__(232);

	var _reactLibUpdate = __webpack_require__(262);

	var _reactLibUpdate2 = _interopRequireDefault(_reactLibUpdate);

	var _coreDemoFixtures = __webpack_require__(263);

	var _coreDemoFixtures2 = _interopRequireDefault(_coreDemoFixtures);

	var _Carousel = __webpack_require__(264);

	var _Carousel2 = _interopRequireDefault(_Carousel);

	var _CarouselItem = __webpack_require__(267);
	...
	var Root = (function (_Component) {
	  ...
	  function Root(props) {
	    ...
	    this.state = {
	      cursor: 0,
	      items: _coreDemoFixtures2['default'].items169,
	      boxes: [{ name: 'Content1', type: "ItemTypes.MANUAL_RULE" }, { name: 'Content2', type: "ItemTypes.MANUAL_RULE" }, { name: 'Content3', type: "ItemTypes.MANUAL_RULE" }],
	      dustbins: [{ accepts: ["ItemTypes.MANUAL_RULE"], lastDroppedItem: null }],
	      droppedBoxNames: []
	    };
	  }
	  ...
	  _createClass(Root, [{
	    ...
	    key: 'handleDrop',
	    value: function handleDrop(index, name, insertAt) {
	      this.setState((0, _reactLibUpdate2['default'])(this.state, {
	        ...
	        items: {
	          $splice: [[insertAt + 1, 0, _coreDemoFixtures2['default'].item]]
	        },
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          dustbins.map(function (_ref, index) {
	            ...
	            return _react2['default'].createElement(_Carousel2['default'], { theme: 'dedcarousel--custom_padding dedcarousel--ratio16_9',
	              items: _this.state.items,
	              sortable: true,
	              moveCard: _this.moveCard,
	              accepts: accepts,
	              onDrop: function (item, insertAt) {
	                return _this.handleDrop(index, item, insertAt);
	              },
	              key: index });
	          })
	        ),
	        _react2['default'].createElement(
	          ...
	          boxes.map(function (_ref2, index) {
	            var name = _ref2.name;
	            var type = _ref2.type;
	            return _react2['default'].createElement(_Card2['default'], { name: name,
	              type: type,
	...
	exports['default'] = (0, _reactDnd.DragDropContext)(_reactDndModulesBackendsHTML52['default'])(Root);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dndCore = __webpack_require__(160);

	var _utilsEnterLeaveCounter = __webpack_require__(203);

	var _utilsEnterLeaveCounter2 = _interopRequireDefault(_utilsEnterLeaveCounter);

	var _utilsBrowserDetector = __webpack_require__(207);

	var _utilsOffsetHelpers = __webpack_require__(214);

	var _utilsShallowEqual = __webpack_require__(216);

	var _utilsShallowEqual2 = _interopRequireDefault(_utilsShallowEqual);

	var _lodashObjectDefaults = __webpack_require__(217);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DragDropManager = __webpack_require__(161);

	exports.DragDropManager = _interopRequire(_DragDropManager);

	var _DragSource = __webpack_require__(199);

	exports.DragSource = _interopRequire(_DragSource);

	var _DropTarget = __webpack_require__(200);

	exports.DropTarget = _interopRequire(_DropTarget);

	var _backendsCreateTestBackend = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxLibCreateStore = __webpack_require__(162);
	...
	var _actionsDragDrop = __webpack_require__(166);

	var dragDropActions = _interopRequireWildcard(_actionsDragDrop);

	var _DragDropMonitor = __webpack_require__(196);

	var _DragDropMonitor2 = _interopRequireDefault(_DragDropMonitor);

	var _HandlerRegistry = __webpack_require__(197);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dragOperation = __webpack_require__(176);

	var _dragOperation2 = _interopRequireDefault(_dragOperation);

	var _refCount = __webpack_require__(190);

	var _refCount2 = _interopRequireDefault(_refCount);

	var _dirtyHandlerIds = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsMatchesType = __webpack_require__(167);
	...
	var _lodashLangIsArray = __webpack_require__(168);

	var _lodashLangIsArray2 = _interopRequireDefault(_lodashLangIsArray);

	var _lodashLangIsObject = __webpack_require__(172);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsRegistry = __webpack_require__(177);

	var _lodashArrayWithout = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIndexOf = __webpack_require__(180),
	    cacheIndexOf = __webpack_require__(182),
	    createCache = __webpack_require__(183);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexOfNaN = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var SetCache = __webpack_require__(184),
	    getNative = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var cachePush = __webpack_require__(185),
	    getNative = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashArrayXor = __webpack_require__(192);

	var _lodashArrayXor2 = _interopRequireDefault(_lodashArrayXor);

	var _lodashArrayIntersection = __webpack_require__(195);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayPush = __webpack_require__(193),
	    baseDifference = __webpack_require__(179),
	    baseUniq = __webpack_require__(194),
	    isArrayLike = __webpack_require__(186);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducersDragOffset = __webpack_require__(165);

	var _reducersDirtyHandlerIds = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsGetNextUniqueId = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashUtilityNoop = __webpack_require__(202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashArrayUnion = __webpack_require__(204);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashFunctionMemoize = __webpack_require__(208);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDelete = __webpack_require__(210),
	    mapGet = __webpack_require__(211),
	    mapHas = __webpack_require__(212),
	    mapSet = __webpack_require__(213);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BrowserDetector = __webpack_require__(207);

	var _createMonotonicInterpolant = __webpack_require__(215);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(218),
	    assignDefaults = __webpack_require__(230),
	    createDefaults = __webpack_require__(231);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assignWith = __webpack_require__(219),
	    baseAssign = __webpack_require__(224),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNative = __webpack_require__(169),
	    ...
	    shimKeys = __webpack_require__(221);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var restParam = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DragDropContext = __webpack_require__(233);
	...
	var _DragSource = __webpack_require__(242);

	exports.DragSource = _interopRequire(_DragSource);

	var _DropTarget = __webpack_require__(257);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCheckDecoratorArguments = __webpack_require__(234);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqualScalar = __webpack_require__(236);

	var _utilsShallowEqualScalar2 = _interopRequireDefault(_utilsShallowEqualScalar);

	var _lodashLangIsPlainObject = __webpack_require__(237);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseForIn = __webpack_require__(238),
	    isArguments = __webpack_require__(206),
	    isObjectLike = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _decorateHandler = __webpack_require__(243);

	var _decorateHandler2 = _interopRequireDefault(_decorateHandler);

	var _registerSource = __webpack_require__(252);

	var _registerSource2 = _interopRequireDefault(_registerSource);

	var _createSourceFactory = __webpack_require__(253);

	var _createSourceFactory2 = _interopRequireDefault(_createSourceFactory);

	var _createSourceMonitor = __webpack_require__(254);

	var _createSourceMonitor2 = _interopRequireDefault(_createSourceMonitor);

	var _createSourceConnector = __webpack_require__(255);

	var _createSourceConnector2 = _interopRequireDefault(_createSourceConnector);

	var _utilsIsValidType = __webpack_require__(256);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _disposables = __webpack_require__(244);
	...
	var _bindConnector2 = __webpack_require__(249);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isDisposable2 = __webpack_require__(245);

	var _isDisposable3 = _interopRequireWildcard(_isDisposable2);

	exports.isDisposable = _isDisposable3['default'];

	var _Disposable2 = __webpack_require__(246);

	var _Disposable3 = _interopRequireWildcard(_Disposable2);

	exports.Disposable = _Disposable3['default'];

	var _CompositeDisposable2 = __webpack_require__(247);

	var _CompositeDisposable3 = _interopRequireWildcard(_CompositeDisposable2);

	exports.CompositeDisposable = _CompositeDisposable3['default'];

	var _SerialDisposable2 = __webpack_require__(248);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isDisposable = __webpack_require__(245);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bindConnectorMethod2 = __webpack_require__(250);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCloneWithRef = __webpack_require__(251);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _registerTarget = __webpack_require__(258);

	var _registerTarget2 = _interopRequireDefault(_registerTarget);

	var _createTargetFactory = __webpack_require__(259);

	var _createTargetFactory2 = _interopRequireDefault(_createTargetFactory);

	var _createTargetMonitor = __webpack_require__(260);

	var _createTargetMonitor2 = _interopRequireDefault(_createTargetMonitor);

	var _createTargetConnector = __webpack_require__(261);
...
/***/ function(module, exports) {
	...
	var DemoFixtures = {
	    item: {
	        id: 8,
	        asset: 'http://lorempixel.com/400/200/city',
	        link: 'https://twitter.com/plusdedev',
	        title: 'Titre 1'
	    },
	    items169: [{
	        id: 0,
	        asset: 'http://lorempixel.com/400/200/sports',
	        link: 'https://twitter.com/plusdedev',
	        title: 'Titre 1'
	    }, {
	        id: 1,
	        asset: 'http://lorempixel.com/400/200/business',
	        link: 'https://twitter.com/plusdedev',
	        title: 'Titre 2'
	    }, {
	        id: 2,
	        asset: 'http://lorempixel.com/400/200/nightlife',
	        link: 'https://twitter.com/plusdedev',
	        title: 'Titre 2'
	    }, {
	        id: 3,
	        asset: 'http://lorempixel.com/400/200/technics',
	        link: 'https://twitter.com/plusdedev',
	        title: 'Titre 2'
	    }, {
	        id: 4,
	        asset: 'http://lorempixel.com/400/200/cats',
	        link: 'https://twitter.com/plusdedev',
	        title: 'Titre 2'
	    }, {
	        id: 5,
	        asset: 'http://lorempixel.com/400/200/animals',
	        link: 'https://twitter.com/plusdedev',
	        title: 'Titre 2'
	    }, {
	        id: 6,
	        asset: 'http://lorempixel.com/400/200/abstract',
	        link: 'https://twitter.com/plusdedev',
	        title: 'Titre 2'
	    }, {
	        id: 7,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coreUtils = __webpack_require__(266);
	...
	var Carousel = (function (_React$Component) {
	  ...
	  function Carousel(props) {
	    ...
	    this.itemsWithUniqIndexes = _coreUtils2['default'].uniqueKeys(props.items, '_index_').slice();
	    // States
	    this.state = {
	    ...
	    this.handleTouchMove = _coreUtils2['default'].throttle(this.handleTouchMove, this.props.dragThrottling, this);
	  ...
	  _createClass(Carousel, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      this.itemsWithUniqIndexes = _coreUtils2['default'].uniqueKeys(nextProps.items, '_index_').slice();
	      var totalPage = _coreUtils2['default'].countPages(nextProps.items.length, this.itemsByPage);
	      this.setState({
	        items: this.itemsWithUniqIndexes,
	    ...
	    value: function componentDidMount() {
	      ...
	      _react2['default'].findDOMNode(this.refs.track).addEventListener('transitionend', this.onTrackTransition.bind(this));
	      // Select the page of an item to show
	      if (this.props.showItemAtIndex) {
	        this.setState({
	          page: _coreUtils2['default'].getPageForIndex(this.props.showItemAtIndex, this.itemsByPage)
	        });
	      }
	      ...
	      this.initAnimationsTimeout = setTimeout(function () {
	        _this.setState({ animate: true });
	        _this.lockAnimation = false;
	      });
	    }
	    ...
	    key: 'setInfiniteBoundaries',
	    value: function setInfiniteBoundaries() {
	      var before = _coreUtils2['default'].pick(this.state.items, this.itemsByPage, true);
	      var after = _coreUtils2['default'].pick(this.state.items, this.itemsByPage);
	    ...
	    key: 'getTrackWidth',
	    value: function getTrackWidth() {
	      return _react2['default'].findDOMNode(this.refs.track).offsetWidth;
	    }
	    ...
	    key: 'setItemsByPage',
	    value: function setItemsByPage() {
	      this.itemsByPage = _coreUtils2['default'].getCSSBeforeContentAsNumber(_react2['default'].findDOMNode(this)) || 1;
	    }
	    ...
	    value: function setTotalPages() {
	      this.setState({
	        totalPages: _coreUtils2['default'].countPages(this.state.items.length, this.itemsByPage)
	      });
	    }
	    ...
	    key: 'getStyleForTransition',
	    value: function getStyleForTransition() {
	      if (!this.itemsByPage) return;

	      var translate3d = undefined,
	          offset = undefined,
	      ...
	      if (this.isLastPage() && !this.props.infinite) {
	        lastPageCount = _coreUtils2['default'].countLastPageItems(this.state.items.length, this.itemsByPage);
	    ...
	    key: 'onTrackTransition',
	    value: function onTrackTransition() {
	    ...
	    key: 'shiftInfinite',
	    value: function shiftInfinite() {
	      var _this2 = this;

	      var toTheRight = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];

	      var items = this.state.items.slice(0);
	      var boundIndex = toTheRight ? 1 : 0;

	      // Get clones items
	      var clones = _coreUtils2['default'].pick(this.itemsWithUniqIndexes, this.itemsByPage, !boundIndex, this.infiniteBounds[boundIndex]);
	      this.infiniteBounds[boundIndex] = clones.currentIndex;

	      // Remove useless items
	      for (var i = 0; i < this.itemsByPage; i++) {
	        toTheRight ? items.shift() : items.pop();
	      }

	      // Add new items
	      if (toTheRight) items = items.concat(clones.result);else items = clones.result.concat(items);
	    ...
	    value: function notifyPageChange(page) {
	    ...
	    key: 'isItemReady',
	    value: function isItemReady(index) {
	      ...
	      // A slide was done, all items should be loaded
	        ...
	        // Load only some items (number items +/- 1/2 number items)
	            ...
	            var offset = this.state.page * this.itemsByPage;
	            if (this.props.infinite) offset += this.itemsByPage;
	            var boundDown = offset - Math.ceil(this.itemsByPage / 2);
	            var boundUp = offset + this.itemsByPage + Math.ceil(this.itemsByPage / 2);
	    ...
	    value: function removeItem(index) {
	      var newItems = [];
	      this.itemsWithUniqIndexes.map(function (item, key) {
	    ...
	    value: function renderItemsList() {
	      ...
	      if (this.state.items.length > 0) {
	        return this.state.items.map(function (item, key) {
	          return _this3.renderItem(item, key);
	        });
	      }
	    }
	    ...
	    value: function render() {
	      ...
	      if (this.state.items.length > this.itemsByPage) {
	        if (!this.isFirstPage() || this.props.infinite) backButton = _react2['default'].createElement('button', { onClick: this.goPrev, className: this.props.basename + '__button ' + this.props.basename + '__button--left' });
	        if (!this.isLastPage() || this.props.infinite) nextButton = _react2['default'].createElement('button', { onClick: this.goNext, className: this.props.basename + '__button ' + this.props.basename + '__button--right' });
	      }

	      // Do the rendering
	      return _react2['default'].createElement(
	        'div',
	        { className: (0, _classnames2['default'])(this.getRootClassName()) },
	        backButton,
	        _react2['default'].createElement(
	          'div',
	          { onTouchStart: this.handleTouchStart, onTouchMove: this.handleTouchMove, onTouchEnd: this.handleTouchEnd, ref: 'track', className: this.props.basename + '__track' },
	          _react2['default'].createElement(
	            'div',
	            { className: this.props.basename + '__content', style: this.getStyleForTransition() },
	    ...
	    key: 'addInstance',
	    value: function addInstance(carousel) {
	    ...
	    value: function addEventListeners() {
	      ...
	      if (!Carousel._instances.length) {
	        throttled = _coreUtils2['default'].throttle(Carousel.onViewportChange, 100, this);
	    ...
	    key: 'setTemplate',
	    value: function setTemplate(key, tpl) {
	    ...
	    value: function getTemplate(key) {
	      if (Carousel._templates[key]) return Carousel._templates[key];else return false;
	    }
	    ...
	    key: 'setGroupWidth',
	    value: function setGroupWidth(group, width) {
	    ...
	    key: 'getGroupWidth',
	    value: function getGroupWidth(group) {
	      return Carousel._groupsWidths[group];
	    }
	  }, {
	    key: 'processGroup',
	    value: function processGroup(group) {
	      Carousel._groupsProcessed.push(group);
	    }
	  }, {
	    key: 'isGroupProcessed',
	    value: function isGroupProcessed(group) {
	      return Carousel._groupsProcessed.indexOf(group) > -1;
	    }
	  }, {
	    key: 'resetGroupProcessed',
	    value: function resetGroupProcessed() {
	...
	Carousel.defaultProps = {
	  ...
	  pageChangeCallback: function pageChangeCallback() {},
	  infinite: false,
	  theme: '',
	  items: [],
	  dragThreshold: 150,
	...
	Carousel.propTypes = {
	  ...
	  customTemplateFn: _react2['default'].PropTypes.string,
	  clickCallback: _react2['default'].PropTypes.func,
	  pageChangeCallback: _react2['default'].PropTypes.func,
	  dragThreshold: _react2['default'].PropTypes.number,
	  group: _react2['default'].PropTypes.string,
	  sortable: _react2['default'].PropTypes.bool,
	  moveCard: _react2['default'].PropTypes.func.isRequired,
	  showItemAtIndex: _react2['default'].PropTypes.oneOfType([_react2['default'].PropTypes.bool, _react2['default'].PropTypes.number])
	};
...
/***/ function(module, exports) {
	...
	var Utils = (function () {
	  ...
	  _createClass(Utils, null, [{
	    key: 'getCSSBeforeContentAsNumber',

	    /**
	     * Get the value contained into a ::before content as a number
	     */
	    value: function getCSSBeforeContentAsNumber(node) {
	      var computedBefore = undefined;
	    ...
	    key: 'countPages',
	    value: function countPages(total, byPage) {
	    ...
	    key: 'countLastPageItems',
	    value: function countLastPageItems(total, byPage) {
	      var pages = Utils.countPages(total, byPage);
	    ...
	    key: 'pick',
	    value: function pick(source, count) {
	      var isReverse = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
	      var currentIndex = arguments.length <= 3 || arguments[3] === undefined ? 0 : arguments[3];
	      var loopIndex = 0;
	      var localSource = source.slice(0);
	      var output = [];
	    ...
	    key: 'uniqueKeys',
	    value: function uniqueKeys(source) {
	      var keyName = arguments.length <= 1 || arguments[1] === undefined ? '_key_' : arguments[1];
	    ...
	    key: 'getPageForIndex',
	    value: function getPageForIndex(itemIndex, itemsByPage) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _deepEqual = __webpack_require__(268);

	var _deepEqual2 = _interopRequireDefault(_deepEqual);

	var _reactDnd = __webpack_require__(232);

	var _Dustbin = __webpack_require__(271);

	var _Dustbin2 = _interopRequireDefault(_Dustbin);

	var _reactMeasure = __webpack_require__(272);
	  ...
	  _createClass(CarouselItem, [{
	    ...
	    value: function componentDidMount() {
	      if (this.props.clickCallback) {
	        _react2['default'].findDOMNode(this).addEventListener('click', this.onItemClicked);
	      }
	    }
	    ...
	    value: function componentWillUnmount() {
	      if (this.props.clickCallback) {
	        _react2['default'].findDOMNode(this).removeEventListener('click', this.onItemClicked);
	      }
	    }
	    ...
	    key: 'getAssetBackground',
	    value: function getAssetBackground(attr) {
	      var bg = this.props.isReady ? 'url(' + attr + ')' : 'none';
	    ...
	    value: function getDefaultTemplate() {
	      return _react2['default'].createElement(
	        'a',
	        { href: this.props.data.link, className: this.props.basename + '__item' },
	        _react2['default'].createElement('div', { className: this.props.basename + '__media', style: this.getAssetBackground(this.props.data.asset) })
	      );
	    }
	  }, {
	    key: 'renderDustbin',
	    value: function renderDustbin() {
	    ...
	    key: 'getSortableTemplate',
	    value: function getSortableTemplate() {
	      var _this = this;
	      ...
	      return connectDragSource(connectDropTarget(_react2['default'].createElement(
	        'span',
	        { className: this.props.basename + '__wrapper' },
	        _react2['default'].createElement(
	          'a',
	          { className: this.props.basename + '__item ' + this.props.basename + '__item--sortable' },
	          _react2['default'].createElement(
	            _reactMeasure2['default'],
	            { onChange: function (d) {
	                return _this.setState({ dimensions: d });
	              } },
	            _react2['default'].createElement('div', { className: this.props.basename + '__media',
	    ...
	    value: function render() {
	      ...
	      if (!this.props.customTemplateFn) return this.getDefaultTemplate();else return this.props.customTemplateFn(this);
	    }
	...
	CarouselItem.defaultProps = {
	  ...
	  isReady: false,
	  clickCallback: null,
	  removeItemFn: function removeItemFn() {}
	};
	...
	CarouselItem.propTypes = {
	  ...
	  moveCard: _react2['default'].PropTypes.func
	};
	...
	var cardTarget = {
	  hover: function hover(props, monitor, component) {
	    ...
	    var boundingRect = _react2['default'].findDOMNode(component).getBoundingClientRect();
	...
	exports['default'] = (0, _reactDnd.DropTarget)("card", cardTarget, function (connect) {
	  return {
	    connectDropTarget: connect.dropTarget()
	  };
	})((0, _reactDnd.DragSource)("card", cardSource, function (connect, monitor) {
	  return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dustbin = (function (_Component) {
	  ...
	  function Dustbin() {
	    ...
	    _get(Object.getPrototypeOf(Dustbin.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(Dustbin, [{
	    ...
	    value: function render() {
	      ...
	      var className = isActive ? 'dustbin dustbin--active' : 'dustbin';
	      return connectDropTarget(_react2['default'].createElement(
	        'div',
	        { style: style, className: className, style: style },
	...
	Dustbin.propTypes = {
	  ...
	  canDrop: _react2['default'].PropTypes.bool.isRequired,
	  accepts: _react2['default'].PropTypes.arrayOf(_react2['default'].PropTypes.string).isRequired,
	  lastDroppedItem: _react2['default'].PropTypes.object,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Measure = __webpack_require__(273);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MeasureChild = __webpack_require__(274);

	var _MeasureChild2 = _interopRequireDefault(_MeasureChild);

	var _getNodeDimensions = __webpack_require__(275);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Box.propTypes = {
	  ...
	  isDropped: _react.PropTypes.bool.isRequired
	};
	exports['default'] = (0, _reactDnd.DragSource)(function (props) {
	  return props.type;
